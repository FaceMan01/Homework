...
{
    // входной файл (по умолчанию: `input.txt`)
    std::cout << "Enter input file name:" << std::endl;
    std::cout << "(default (empty input line) = `input.txt`)" << std::endl;
    ...
    // выходной файл (по умолчанию: `output_` + [inputFileName])
    std::cout << "Enter output file name:" << std::endl;
    std::cout << "(default (empty input line) = `output_` + [inputFileName])" << std::endl;
    ...
    // возвращаем граф к его исходному представлению
    switch (inputGraphRepresentation)
    {
